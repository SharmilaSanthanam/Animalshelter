            ...
            <Grid item xs={12} sx={{ textAlign: "start", display: { xs: 'block', md: 'none' } }}>
             ...
             <Grid item xs={12} sx={{ display: { xs: 'block', md: 'none' } }}>
              <Button type="submit"
                ...
                variant="contained" style={{ color: "white", backgroundColor: "#FF6584", borderRadius: "5px", width: "15rem" }} fullWidth>REQUEST FOR GIVE AWAY</Button>
            </Grid>
            <Grid item xs={12} sx={{ display: { xs: 'none', md: 'block' } }}>
              <Button type="submit"
                onClick={handleSubmit}
                variant="contained" style={{ color: "white", backgroundColor: "#FF6584", borderRadius: "5px", width: "15rem", marginLeft: "18rem" }} fullWidth>REQUEST FOR GIVE AWAY</Button>
            </Grid>
          </Grid>
        </form>
